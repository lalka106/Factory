...
$type_selected = selectONE('type_product',['id'=>$product['id_type_product']]);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <form action="edit.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col mb-4">
                        <input value="<?= $product['name'] ?>" name="name" type="text" class="form-control"
                               placeholder="Title" aria-label="Название новости">
                    </div>
                    <div class="col mb-4">
                        <input value="<?= $product['description'] ?>" name="description" type="text"
                               class="form-control" placeholder="Title" aria-label="Название новости">
                    </div>
                    <div class="col mb-4">
                        <label for="editor" class="form-label">Характеристики</label>
                        <textarea name="characteristic" class="form-control" id="editor"
                                  rows="6"><?= $product['characteristic']; ?></textarea>
                    </div>
                    <div class="col mb-4">
                    ...
                    <div class="col mb-4">
                        <input value="<?= $product['count'] ?>" name="count" type="number" class="form-control"
                               placeholder="Title" aria-label="Название новости">
                    </div>
